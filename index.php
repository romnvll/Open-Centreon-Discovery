      ...
      <div class="col-sm">
        ...
        <body class="text-center">
          <form class="form-signin" action="verif.php" method="POST">
            ...
            <input type="text" class="form-control" <?php if (isset($_GET['community'])) echo "value=" . $_GET['community'];
                                                    else  echo " " ?> name="community" id="community" placeholder="La communaut&#233;">
            <br>
